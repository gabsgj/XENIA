...
>(({ className, ...props }, ref) => (
    ...
    ref={ref}
    className={cn(
      // overlay should sit beneath the content so it doesn't intercept pointer events
...
>(({ className, children, ...props }, ref) => (
  <ModalPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // constrain size so very tall modals don't overflow the viewport and make content unclickable
