...
export default function Home() {
  ...
  return (
  <div className="min-h-screen bg-background pt-4 md:pt-6">
      {/* Header */}
  <header className="fixed top-0 left-0 right-0 z-50 py-2 px-6 md:px-12 lg:px-16 flex justify-between items-center bg-background/95 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 transition-all duration-300">
      ...
      {/* Hero Section */}
  <section className="relative pt-8 pb-12 md:pt-12 md:pb-20 px-4 md:px-6 lg:px-12 xl:px-20">
  ...
  <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 md:w-[600px] md:h-[600px] bg-slate-50/20 dark:bg-slate-900/06 rounded-full blur-2xl opacity-20 pointer-events-none"></div>
        ...
        <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative">
            {/* Floating Cards */}
            <div className="absolute -top-2 -left-6 z-50" style={{animationDelay: '0s'}}>
            ...
            {/* Main Dashboard Preview */}
              <Card className="relative mt-6 md:mt-8 border border-slate-200 dark:border-slate-700 shadow-2xl bg-white dark:bg-slate-900/50 backdrop-blur-sm">
              <CardContent className="p-6 md:p-8">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-3 gap-2">
                  <div>
                    <h3 className="text-lg font-semibold">Your Study Dashboard</h3>
                    <p className="text-xs text-muted-foreground">Live demo of study plan generation</p>
                  </div>
                  <div className="flex items-center gap-2">
                    <Badge className="bg-rose-50 text-rose-700 dark:bg-rose-900/20 dark:text-rose-200 text-xs px-2 py-0.5">Live Demo</Badge>
                    <div className="px-2 py-0.5 rounded-full bg-slate-100 dark:bg-slate-800/40 text-xs font-medium text-slate-700 dark:text-slate-200">Study Plan</div>
                  </div>
                </div>

                {/* Colorful status / processing row */}
                <div className="flex flex-wrap items-center gap-3 mb-3 text-sm">
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 rounded-full bg-slate-500 animate-pulse" />
                    <span className="text-muted-foreground">Syllabus Uploaded</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 rounded-full bg-indigo-400" />
                    <span className="text-muted-foreground">Extracting topics</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 rounded-full bg-teal-400" />
                    <span className="text-muted-foreground">Creating personalized path</span>
                  </div>
                </div>
  ...
  {/* Footer */}
  <footer className="bg-slate-100 dark:bg-slate-900 text-black dark:text-white py-12 px-6 md:px-12 lg:px-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-black/80 dark:text-slate-300/80 hover:text-black dark:hover:text-white transition-all">Help Center</a></li>
              <li><a href="#" className="text-black/80 dark:text-slate-300/80 hover:text-black dark:hover:text-white transition-all">Contact Us</a></li>
              <li><a href="#" className="text-black/80 dark:text-slate-300/80 hover:text-black dark:hover:text-white transition-all">Documentation</a></li>
              <li><a href="#" className="text-black/80 dark:text-slate-300/80 hover:text-black dark:hover:text-white transition-all">API</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-black/80 dark:text-slate-300/80 hover:text-black dark:hover:text-white transition-all">About</a></li>
              <li><a href="#" className="text-black/80 dark:text-slate-300/80 hover:text-black dark:hover:text-white transition-all">Privacy</a></li>
              <li><a href="#" className="text-black/80 dark:text-slate-300/80 hover:text-black dark:hover:text-white transition-all">Terms</a></li>
              <li><a href="#" className="text-black/80 dark:text-slate-300/80 hover:text-black dark:hover:text-white transition-all">Security</a></li>
            </ul>
          </div>
        </div>
